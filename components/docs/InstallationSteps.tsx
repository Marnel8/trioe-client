...
const InstallationStepContent: FC<InstallationStepContentProps> = ({ step, onComplete }) => {
  const steps = [
    {
              ...
              <div className="p-4 bg-white rounded-lg shadow-sm">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Latest version: 3.5</div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Double-click the installer and follow the prompts. You may need administrator privileges.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="font-medium mb-2">Verify Installation</div>
                      <p className="text-sm text-gray-600">
                        Connect your TRIOE board and check Device Manager for the COM port
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      <span>Board</span>
                      <span className="font-mono bg-gray-100 px-2 py-1 rounded">ESP32 Dev Module</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Upload Speed</span>
                      <span className="font-mono bg-gray-100 px-2 py-1 rounded">115200</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>CPU Frequency</span>
                      <span className="font-mono bg-gray-100 px-2 py-1 rounded">240MHz</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Flash Frequency</span>
                      <span className="font-mono bg-gray-100 px-2 py-1 rounded">80MHz</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Flash Mode</span>
                      <span className="font-mono bg-gray-100 px-2 py-1 rounded">QIO</span>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Check if the correct board and port are selected. Try pressing the reset button before upload.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <AlertCircle className="w-5 h-5 text-red-500 flex-shrink-0" />
                      <div>
                        <div className="font-medium text-sm">Port Not Found</div>
                        <p className="text-sm text-gray-600">
                          Verify the USB connection and driver installation. Try a different USB cable or port.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <AlertCircle className="w-5 h-5 text-red-500 flex-shrink-0" />
                      <div>
                        <div className="font-medium text-sm">Compilation Error</div>
                        <p className="text-sm text-gray-600">
                          Make sure you have the latest board package installed and all required libraries.
                        </p>
                      </div>
                    </div>
                  </div>
