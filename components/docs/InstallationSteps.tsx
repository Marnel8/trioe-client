                                ...
                                <div className="p-4 bg-white rounded-lg shadow-sm">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Double-click the installer and
                                                follow the prompts. You may need
                                ...
                                <div className="p-4 bg-white rounded-lg shadow-sm">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Connect your TRIOE board and
                                                check Device Manager for the COM
                                                port
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-4 bg-white rounded-lg shadow-sm">
                                    <ol className="list-decimal list-inside space-y-3">
                                        ...
                                        <li className="text-sm">
                                            Search for "esp32" and install the
                                            latest version
                                        </li>
                                    </ol>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-4 bg-white rounded-lg shadow-sm">
                                    ...
                                    <p className="text-sm text-gray-600 mb-3">
                                        Select the correct COM port for your
                                        TRIOE board:
                                    </p>
                                    <div className="relative aspect-video w-full rounded-lg overflow-hidden">
                                        <Image
                            ...
                            <div className="space-y-4">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">
                                                    Check if the correct board
                                                    and port are selected. Try
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">
                                                    ...
                                                    and driver installation. Try
                                                    a different USB cable or
                                                    port.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="p-4 bg-white rounded-lg shadow-sm">
                                    ...
                                    <p className="text-sm text-gray-600 mb-4">
                                        If you're still having issues, check out
                                        these resources:
                                    </p>
