	...
	>
		<div
			className={`flex items-center justify-center w-10 h-10 rounded-full ${
				isActive ? "bg-green-500" : isCompleted ? "bg-green-500" : "bg-gray-300"
			}`}
		>
			<Icon />
		</div>
...
const QuickStartStepContent: FC<QuickStartStepContentProps> = ({
	step,
	onComplete,
}) => {
	const steps = [
							...
							<div className="space-y-4">
								<div className="p-4 bg-white rounded-lg shadow-sm">
									<ol className="list-decimal list-inside space-y-3">
										...
										<li className="text-sm">
											Go to File → Examples → TRIOE → BasicTest
										</li>
										<li className="text-sm">
											The example code will open in a new window
										</li>
									</ol>
								</div>
								<div className="p-4 bg-white rounded-lg shadow-sm">
										...
										<li className="flex items-start gap-3">
											...
											<div>
												...
												<span className="text-sm text-gray-600">
													Initializes serial communication and LED pin
												</span>
											</div>
										</li>
										<li className="flex items-start gap-3">
											...
											<div>
												...
												<span className="text-sm text-gray-600">
													Blinks the LED with 1-second intervals
												</span>
											</div>
										</li>
									</ul>
						...
						<div>
							...
							<div className="space-y-4">
								<div className="p-4 bg-white rounded-lg shadow-sm">
									<ol className="list-decimal list-inside space-y-3">
										<li className="text-sm">
											Verify board selection (Tools → Board)
										</li>
										<li className="text-sm">
									...
									<ul className="space-y-3">
										<li className="flex items-start gap-3">
											...
											<div>
												<a
													href="#"
													className="font-medium block text-sm text-green-500 hover:underline"
												>
