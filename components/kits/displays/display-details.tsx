...
const DisplayDetails = ({ displayId }: { displayId: string }) => {
                    ...
                    <div className="lg:w-1/2">
                        <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                            ...
                            <CardContent className="p-6">
                                <p className="text-gray-700 leading-relaxed">{display.detail}</p>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                            <CardContent className="p-6">
                                ...
                                <Table>
                                    <TableBody>
                                        {display.pinDescription.map((pin, index) => (
                                            <TableRow
                                                key={pin.pin}
                ...
                <Card className="mb-16 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <CardContent className="p-6">
                        ...
                        <div className="relative bg-gray-100 p-4 rounded-lg">
                            <CopyButton text={display.sampleCode.code} />
                            <div className="overflow-x-auto">
                                <Code
                                    lang={display.sampleCode.language}
                                    theme="github-light"
                                    className="text-sm"
                                >
                                    {display.sampleCode.code}
                                </Code>
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card className="mb-16 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <CardContent className="p-6">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                            ...
                            Crash Course: Using the {display.name}
                        </h2>
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="text-gray-700">{display.crashCourse.objective}</p>
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-3">
                                    Materials Required
                                ...
                                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                                    {display.crashCourse.materialsRequired.map((material) => (
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {display.crashCourse.steps.map((step, index) => (
                                        <div
                                            key={index}
                ...
                <Card className="mb-16 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <CardContent className="p-6">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                            ...
                            Video Tutorial: Using the {display.name}
                        </h2>
                        <div className="aspect-video rounded-lg overflow-hidden">
                            <iframe
                                className="w-full h-[400px]"
                                src={display.videoUrl}
                                title={`${display.name} Tutorial`}
                ...
                <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {display.commonApplications.map((app, index) => (
                                <div
                                    key={index}
