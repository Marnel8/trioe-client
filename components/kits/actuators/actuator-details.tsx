...
const ActuatorDetails = ({ actuatorId }: { actuatorId: string }) => {
					...
					<div className="lg:w-1/2 space-y-8">
						...
						<Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
							<CardContent className="p-6">
								...
								<Table>
									<TableBody>
										{actuator.pinDescription.map((pin, index) => (
											<TableRow
												key={pin.pin}
					...
					<CardContent className="p-6">
						...
						<div className="relative bg-gray-100 p-4 rounded-lg">
							...
							<div className="overflow-x-auto">
								<Code
									lang={actuator.sampleCode.language}
									theme="github-light"
									className="text-sm"
								>
				...
				<Card className="mb-16 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
					<CardContent className="p-6">
						<h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
							...
							Crash Course: Control a light bulb with a relay
						</h2>
				...
				<Card className="mb-16 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
					<CardContent className="p-6">
						<h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
							...
							Video Tutorial: Control a light bulb with a relay
						</h2>
