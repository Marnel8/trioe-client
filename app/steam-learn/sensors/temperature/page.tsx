  ...
  sections: [
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Temperature sensors are essential components in many applications, from
            industrial processes to consumer electronics. Understanding different types
            and their characteristics is crucial for proper selection and implementation.
          </p>
  ...
  return sensors.getTempCByIndex(0);
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Humidity sensors measure the amount of water vapor in the air. They are
            crucial for environmental monitoring, HVAC systems, and industrial processes.
          </p>
  ...
  return dht.readHumidity();
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Environmental monitoring systems combine temperature and humidity sensors
            to provide comprehensive climate control and data collection.
          </p>
          <div className="grid grid-cols-1 gap-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Monitoring System Example</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="bg-white/50 p-4 rounded-md">
  ...
  public:
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Data logging is essential for tracking environmental conditions over time
            and analyzing trends. Modern systems often include cloud connectivity and
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          {currentSection === lesson.sections.length - 1 ? (
            <Button asChild>
              <Link href="/steam-learn/sensors/motion">
                Next Lesson
