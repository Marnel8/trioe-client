  ...
  sections: [
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Digital Input/Output (I/O) operations are fundamental to microcontroller programming.
            They allow the microcontroller to interact with the external world through pins
            that can be set as either inputs or outputs.
          </p>
...
if (buttonState == HIGH) {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Understanding variables and data types is crucial for efficient microcontroller
            programming. Different data types use different amounts of memory and are
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  <li><code>bool</code>: 1 byte (true/false)</li>
                  <li><code>byte</code>: 1 byte (0-255)</li>
                  <li><code>int</code>: 2 bytes (-32,768 to 32,767)</li>
                  <li><code>long</code>: 4 bytes (±2,147,483,647)</li>
                  <li><code>float</code>: 4 bytes (decimal numbers)</li>
                </ul>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  <li><code>volatile</code>: For ISR variables</li>
                  <li><code>const</code>: For constants</li>
                  <li><code>static</code>: Preserve value</li>
                  <li><code>unsigned</code>: Positive only</li>
                </ul>
              </CardContent>
            </Card>
          </div>
...
static int counter = 0;`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Control structures determine the flow of program execution. They allow you
            to make decisions and repeat actions based on conditions.
          </p>
          <Card className="border-green-200 bg-green-50/50">
            <CardHeader>
              <CardTitle className="text-lg">Common Control Structures</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
...
do {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Functions help organize code into reusable blocks, while libraries provide
            pre-written code for common tasks. Understanding both is essential for
