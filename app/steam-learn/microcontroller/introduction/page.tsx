  ...
  sections: [
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            A microcontroller is a compact integrated circuit designed to govern the
            operation of embedded systems. Think of it as a small computer on a
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Microcontroller architecture follows a structured design that enables
            efficient embedded system control. The main components work together
            to execute programs and interact with the external world.
          </p>
          <Card className="border-blue-200 bg-blue-50/50">
            <CardHeader>
              <CardTitle className="text-lg">Core Architecture Components</CardTitle>
            </CardHeader>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            To start programming microcontrollers, you'll need to set up a proper
            development environment. Here are the essential components:
          </p>
          <Card className="border-purple-200 bg-purple-50/50">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h4 className="font-semibold">1. Integrated Development Environment (IDE)</h4>
                <ul className="list-disc list-inside pl-4">
