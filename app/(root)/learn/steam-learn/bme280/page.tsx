...
void setup() {
  ...
  if (!bme.begin(0x76)) {
    ...
    output: {
      ...
      description: "Successful initialization of BME280 sensor showing I2C connection and sensor ID"
    }
  },
  {
...
void loop() {
  ...
  delay(1000);
    ...
    output: {
      ...
      description: "Serial monitor showing real-time temperature readings in Celsius"
    }
  },
  {
...
void loop() {
  ...
  delay(1000);
    ...
    output: {
      ...
      description: "Serial monitor displaying current relative humidity percentage"
    }
  },
  {
...
void loop() {
  ...
  delay(1000);
    ...
    output: {
      ...
      description: "Serial monitor showing atmospheric pressure readings in hPa"
    }
  },
  {
    title: "Data Logging",
...
void logData() {
  ...
  if (dataFile) {
    ...
    output: {
      ...
      description: "Example of logged data showing temperature, humidity, and pressure over time"
    }
  },
];
                ...
                <div className="mt-4">
                  ...
                  <div className="relative h-48 md:h-64">
                    <Image
                      ...
                      alt={lesson.output.alt}
                      fill
                      className="object-contain rounded-lg"
                    />
                  </div>
                  <p className="text-sm text-gray-600 mt-2">{lesson.output.description}</p>
                </div>
              )}
            </CardContent>
          </Card>
