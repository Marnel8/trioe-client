			...
			content: (
				<div className="space-y-4">
					<p>
						...
						vibration, and orientation. They are fundamental to many modern
			...
			content: (
				<div className="space-y-4">
					<p>
						...
						and rotation. They are often used in combination with accelerometers
						for more accurate motion tracking.
					</p>
  ...
  angle += rotZ * deltaTime;
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Position sensors determine the location or displacement of an
						object. They come in various forms and use different technologies
