...
const quizQuestions = [
	{
		...
		correctAnswer: "45-49%",
		explanation:
			"Minerals typically make up 45-49% of soil composition, with the rest being water, air, and organic matter.",
	},
	{
		id: 2,
		question:
			"Which soil particle type has the highest nutrient retention capacity?",
		options: ["Sand", "Silt", "Clay", "Gravel"],
		correctAnswer: "Clay",
		explanation:
			"Clay particles are the smallest and have the highest surface area, giving them the best ability to retain nutrients.",
	},
	{
		id: 3,
		...
		explanation:
			"Most crops grow best in soil with a pH between 6.0 and 7.5, as this range provides optimal nutrient availability.",
	},
	{
		id: 4,
		question:
			"Which nutrient is essential for leaf growth and chlorophyll production?",
		options: ["Phosphorus", "Potassium", "Nitrogen", "Calcium"],
		correctAnswer: "Nitrogen",
		explanation:
			"Nitrogen is crucial for leaf growth and chlorophyll production, which is essential for photosynthesis.",
	},
	{
		id: 5,
		...
		explanation:
			"Soil testing helps determine nutrient levels, pH, and other properties to guide proper soil management.",
	},
	{
		id: 6,
		question:
			"Which conservation practice involves planting along the natural contours of the land?",
		options: [
			"Strip cropping",
			"Contour farming",
			"Vertical farming",
		...
		explanation:
			"Contour farming involves planting along the natural contours of the land to reduce soil erosion.",
	},
	{
		id: 7,
		...
		explanation:
			"Organic matter improves soil structure, water retention, and provides nutrients for plants.",
	},
	{
		id: 8,
		question:
			"Which secondary nutrient is essential for cell wall development in plants?",
		options: ["Magnesium", "Sulfur", "Calcium", "Iron"],
		correctAnswer: "Calcium",
		explanation:
			"Calcium is a secondary nutrient that plays a crucial role in cell wall development and structure.",
	},
	{
		id: 9,
		question:
			"What type of erosion is primarily caused by rainfall and runoff?",
		options: [
			"Wind erosion",
			"Water erosion",
			"Tillage erosion",
		...
		explanation:
			"Water erosion occurs when rainfall and runoff carry away soil particles, especially on sloped land.",
	},
	{
		id: 10,
		...
		explanation:
			"Cover cropping protects soil from erosion by maintaining plant cover during off-seasons.",
	},
];
