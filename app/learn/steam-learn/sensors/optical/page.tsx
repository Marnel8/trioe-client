			...
			content: (
				<div className="space-y-4">
					<p>
						...
						electrical current. They are fundamental components in many optical
  ...
  return lux;
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Image sensors convert optical images into electronic signals. They
						are the core component of digital cameras and many vision-based
						sensors.
					</p>
  ...
  wrSensorReg8_8(0x11, 0x80);
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Color detection sensors use filtered photodiodes or specialized ICs
						to measure different wavelengths of light and determine colors.
					</p>
					<div className="grid grid-cols-1 gap-4">
						<Card>
							<CardHeader>
								<CardTitle className="text-lg">
									Color Sensing Implementation
								</CardTitle>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
