	...
	sections: [
			...
			content: (
				<div className="space-y-4">
					<p>
						...
						physical environment. They convert physical phenomena into
						electrical signals that can be measured and processed.
					</p>
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Understanding sensor characteristics is crucial for selecting the
						right sensor for your application and interpreting its measurements
						correctly.
					</p>
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Signal conditioning is the process of converting and modifying
						sensor output to make it suitable for further processing or display.
					</p>
					<div className="grid grid-cols-1 gap-4">
						<Card>
							<CardHeader>
								<CardTitle className="text-lg">
									Common Signal Conditioning Steps
								</CardTitle>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
...
where R is resistance, A,B,C are constants`}
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Calibration ensures accurate measurements by establishing the
						relationship between sensor output and known reference values.
					</p>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<Card>
							<CardHeader>
