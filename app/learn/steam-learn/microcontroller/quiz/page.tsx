...
const quizQuestions = [
  {
    ...
    explanation: "Microcontrollers include integrated peripherals (memory, I/O, timers) on a single chip, while microprocessors require external components for these functions.",
  },
  {
    id: 2,
    question: "Which statement correctly describes the volatile keyword in embedded C programming?",
    options: [
    ...
    explanation: "The volatile keyword indicates that a variable's value may change without direct code action, important for hardware registers and ISRs.",
  },
  {
    id: 3,
    ...
    explanation: "ISRs are special functions that handle asynchronous events (interrupts) that require immediate attention from the microcontroller.",
  },
  {
    id: 4,
    ...
    explanation: "In I2C protocol, SDA (Serial Data) carries data and SCL (Serial Clock) provides timing synchronization between devices.",
  },
  {
    id: 5,
    ...
    explanation: "PWM (Pulse Width Modulation) can simulate analog signals using digital pulses, useful for controlling motors, LEDs, and other analog devices.",
  },
  {
    id: 6,
    question: "Which memory type is typically used to store the program code in a microcontroller?",
    options: [
      "RAM",
      "Flash",
      "EEPROM",
    ...
    correctAnswer: "Flash",
    explanation: "Flash memory is non-volatile and can be electrically erased and reprogrammed, making it ideal for storing program code in microcontrollers.",
  },
  {
    id: 7,
    ...
    explanation: "A watchdog timer resets the microcontroller if the program fails to clear it periodically, preventing system lockups.",
  },
  {
    id: 8,
    question: "Which communication protocol is best suited for long-distance communication?",
    options: [
      "SPI",
      "I2C",
      "UART",
    ...
    correctAnswer: "UART",
    explanation: "UART (Universal Asynchronous Receiver/Transmitter) is better suited for longer distances due to its simple two-wire interface and noise resistance.",
  },
  {
    id: 9,
    ...
    explanation: "The Analog-to-Digital Converter (ADC) converts analog voltage levels into digital values that the microcontroller can process.",
  },
  {
    id: 10,
    question: "Which power-saving technique halts the CPU but keeps peripherals running?",
    options: [
      "Sleep mode",
      "Deep sleep mode",
      "Idle mode",
    ...
    explanation: "Idle mode stops the CPU clock while keeping peripheral clocks running, allowing interrupts to wake the system while saving power.",
  },
];
    ...
    <div className="container mx-auto max-w-4xl p-4 space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test your knowledge of microcontroller concepts, programming, and applications
          </CardDescription>
