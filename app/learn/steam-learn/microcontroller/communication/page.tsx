	...
	sections: [
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Universal Asynchronous Receiver/Transmitter (UART) is a simple yet
						powerful serial communication protocol widely used in embedded
						systems.
					</p>
			...
			content: (
				<div className="space-y-4">
					<p>
						...
						including speed requirements, distance, number of devices, and
						complexity.
					</p>
