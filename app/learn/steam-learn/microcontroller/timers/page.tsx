	...
	sections: [
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Timers are essential components in microcontrollers that can measure
						time intervals, generate signals, and trigger events at precise
						moments.
					</p>
...
TIMSK1 |= (1 << OCIE1A);`}
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Interrupts allow the microcontroller to respond to events
						immediately, regardless of what the main program is doing. Different
						types of interrupts serve different purposes.
					</p>
    ...
    buttonPressed = true;
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					<p>
						Real-time applications require precise timing and immediate response
						to events. Timers and interrupts are crucial for implementing such
						systems.
					</p>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<Card>
